Progetto individuale, per utilizzare al meglio il mio tempo libero. :D

Un'applicazione web moderna che aggrega le ultime notizie dal mondo dell'informatica in tempo reale, utilizzando le API di "Hacker News". 
Il progetto è nato per simulare l'interazione tipica di un bot informativo, trasportata su un'interfaccia web pulita e reattiva.
...
* [ ] Dashboard con grafici sull'andamento dei linguaggi di programmazione.
